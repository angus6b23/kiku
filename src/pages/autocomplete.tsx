...
export default () => {
        ...
        autocompleteDropdownSimple.current = f7.autocomplete.create({
            ...
            source(query, render) {
                ...
                for (let i = 0; i < fruits.length; i += 1) {
                    if (
                        fruits[i].toLowerCase().indexOf(query.toLowerCase()) >=
                        0
                    )
    ...
    return (
        <Page onPageInit={onPageInit} onPageBeforeRemove={onPageBeforeRemove}>
            ...
            <Block>
                <p>
                    Dropdown autocomplete is good to use as a quick and simple
                    solution to provide more options in addition to free-type
                    value.
                </p>
            </Block>
            ...
            <Block>
                <p>
                    Standalone autocomplete provides better mobile UX by opening
                    it in a new page or popup. Good to use when you need to get
