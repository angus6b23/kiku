import React, { useState, type ReactElement, ChangeEvent, useEffect } from "react"
...
export default function InstanceSetting(props: InstanceSettingProps): ReactElement {
    ...
    return (
        ...
        <Block className="mt-2">
            ...
            <List sortable sortableEnabled dividers onSortableSort={handleInstanceSort}>
                                ...
                                {instance.type !==
                                    'local' && (
                                        <div>
                                            ...
                                            <input
                                                type="options"
                                                className="ml-2 bg-[--f7-md-surface-1] border-b-[1px] border-[--f7-md-on-surface] text-[--f7-md-on-surface] focus:border-[--f7-theme-color] focus:border-b-2 w-50"
